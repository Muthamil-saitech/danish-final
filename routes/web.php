...
Route::group(['middleware' => ['XSS']], function () {
    ...
    Route::middleware(['auth','set_locale', 'has_permission', 'is_first_login'])->group(function () {
        ...
        Route::post('getSalesItems', [App\Http\Controllers\AjaxController::class, 'getSalesItems'])->name('getSalesItems.post');
        Route::post('/salesNoteEntry', [App\Http\Controllers\SalesController::class, 'salesNoteEntry'])->name('salesNoteEntry');
        ...
        Route::post('/instrument-pay-entry', [App\Http\Controllers\InstrumentPaymentController::class, 'instrumentPayEntry'])->name('instrument-pay-entry');
        ...
        Route::get('view-customer-inward-io/{id}', [App\Http\Controllers\CustomerIOController::class, 'inwardIO'])->name('view-customer-inward-io');
        Route::get('view-customer-outward-io/{id}', [App\Http\Controllers\CustomerIOController::class, 'outwardIO'])->name('view-customer-outward-io');
        ...
        Route::get('/customer-inward-io-download/{id}', [App\Http\Controllers\CustomerIOController::class, 'downloadInwardIo'])->name('customer-inward-io-download');
        Route::get('/customer-outward-io-download/{id}', [App\Http\Controllers\CustomerIOController::class, 'downloadOutwardIo'])->name('customer-outward-io-download');
        Route::get('/customer-inward-io-print/{id}', [App\Http\Controllers\CustomerIOController::class, 'printInward'])->name('customer-inward-io-print');
        Route::get('/customer-outward-io-print/{id}', [App\Http\Controllers\CustomerIOController::class, 'printOutward'])->name('customer-outward-io-print');
        ...
        Route::get('view-partner-inward-io/{id}', [App\Http\Controllers\PartnerIOController::class, 'inwardIO'])->name('view-partner-inward-io');
        Route::get('view-partner-outward-io/{id}', [App\Http\Controllers\PartnerIOController::class, 'outwardIO'])->name('view-partner-outward-io');

        Route::get('/partner-inward-io-download/{id}', [App\Http\Controllers\PartnerIOController::class, 'downloadInward'])->name('partner-inward-io-download');
        Route::get('/partner-outward-io-download/{id}', [App\Http\Controllers\PartnerIOController::class, 'downloadOutward'])->name('partner-outward-io-download');
        Route::get('/partner-inward-io-print/{id}', [App\Http\Controllers\PartnerIOController::class, 'printInward'])->name('partner-inward-io-print');
        Route::get('/partner-outward-io-print/{id}', [App\Http\Controllers\PartnerIOController::class, 'printOutward'])->name('partner-outward-io-print');
        /* Material Stock */
        ...
        Route::get('material_stock_return/{id}', [App\Http\Controllers\MaterialStockController::class, 'material_stock_return']);
        Route::get('/material-return-print/{id}', [App\Http\Controllers\MaterialStockController::class, 'printMaterialReturn'])->name('material-return-print');
        Route::get('/download-material-return/{id}', [App\Http\Controllers\MaterialStockController::class, 'downloadMaterialReturn'])->name('download-material-return');
        ...
        Route::post('stock_return', [App\Http\Controllers\MaterialStockController::class, 'stockReturn'])->name('material_stocks.stockReturn');
        ...
        Route::get('/print-task-schedule/{id}', [App\Http\Controllers\ProductionController::class, 'print_task'])->name('print-task-schedule');
        Route::get('/download-task-download/{id}', [App\Http\Controllers\ProductionController::class, 'download_task'])->name('download-task-download');
        ...
        Route::get('sales/{id}/sales_items_list', [App\Http\Controllers\SalesController::class, 'saleItemsList']);
        Route::get('sales/{id}/invoice_note_entry', [App\Http\Controllers\SalesController::class, 'saleNoteEntries']);
        Route::get('/sales-note-print/{id}', [App\Http\Controllers\SalesController::class, 'printSaleNoteEntries'])->name('sales-note-print');
        ...
        //Instruments Payment
        Route::resource('instruments-payment', App\Http\Controllers\InstrumentPaymentController::class);
        Route::get('/instrument-payment-view/{id}', [App\Http\Controllers\InstrumentPaymentController::class, 'paymentEntry'])->name('instrument-payment-view');
        Route::get('/instruments_payment_print/{id}', [App\Http\Controllers\InstrumentPaymentController::class, 'print'])->name('instruments-payment-print');
        ...
        Route::get('po-report', [App\Http\Controllers\ReportController::class, 'poReport'])->name('po-report');
        Route::get('po-report/export', [App\Http\Controllers\ReportController::class, 'exportPOReport'])->name('po-report.export');
        Route::get('production-report', [App\Http\Controllers\ReportController::class, 'productionReport'])->name('production-report');
        Route::get('supplier-purchase-report', [App\Http\Controllers\ReportController::class, 'supplierPurchaseReport'])->name('supplier-purchase-report');
        Route::get('customer-report', [App\Http\Controllers\ReportController::class, 'customerSearchReport'])->name('customer-report');
        Route::post('customer-auto-search', [App\Http\Controllers\AjaxController::class, 'customerAutoSearch'])->name('customerAutoSearch.post');
        Route::post('load-customer-report', [App\Http\Controllers\ReportController::class, 'loadCustomerReport'])->name('loadCustomerReport.post');
        Route::post('load-po-report', [App\Http\Controllers\ReportController::class, 'loadPOReport'])->name('loadPOReport.post');
        Route::get('instrument-report', [App\Http\Controllers\ReportController::class, 'instrumentReport'])->name('instrument-report');
        Route::post('instruments-auto-search', [App\Http\Controllers\AjaxController::class, 'instrumentAutoSearch'])->name('instrumentAutoSearch.post');
        Route::get('load-instrument-report', [App\Http\Controllers\ReportController::class, 'loadInstrumentReport'])->name('load-instrument-report');
        Route::get('payment-report', [App\Http\Controllers\ReportController::class, 'paymentReport'])->name('payment-report');
        Route::post('reference-auto-search', [App\Http\Controllers\AjaxController::class, 'referenceAutoSearch'])->name('referenceAutoSearch.post');
