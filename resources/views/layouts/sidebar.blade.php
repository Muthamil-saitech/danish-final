...
<section class="sidebar">
    ...
    <div id="left_menu_to_scroll">
        <ul class="sidebar-menu ps ps--active-x ps--active-y tree" data-widget="tree">
                ...
                <li
                    ...
                    <ul class="treeview-menu">
                        @if (routePermission('customer.create'))
                            <li class="menu_assign_class {{ request()->routeIs('customers.create') || request()->routeIs('customers.edit') ? ' treeMenuActive' : '' }}" data-menu__cid="irp_10"><a
            ...
            @endif
            @if (menuPermission('RGP Inward Outward'))
                <li class="parent-menu treeview menu__cidirp_10 {{ request()->is('inward_outward*') || request()->is('customer_io*') || request()->is('partner_io*') || request()->is('view-customer-inward-io*') || request()->is('view-customer-outward-io*') || request()->is('view-partner-inward-io*') || request()->is('view-partner-outward-io*') ? 'menu-open active_sub_menu' : '' }}">
                    <a href="#">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="menu_assign_class {{ request()->routeIs('customer_io.index') || request()->routeIs('view-customer-inward-io*') || request()->routeIs('view-customer-outward-io*') ? ' treeMenuActive' : '' }}" data-menu__cid="irp_10"><a
                        ...
                        <li class="menu_assign_class {{ request()->routeIs('partner_io.index') || request()->routeIs('view-partner-inward-io*') || request()->routeIs('view-partner-outward-io*') ? ' treeMenuActive' : '' }}" data-menu__cid="irp_10"><a
            ...
            @endif
            @if (menuPermission('Instruments Payment List'))
                <li class="parent-menu treeview2 menu_assign_class menu__cidirp_1{{ request()->is('instruments-payment*') ? ' menu-open active_sub_menu' : '' }}"
                    data-menu__cid="irp_1">
                    <a href="{{ route('instruments-payment.index') }}">
                        <iconify-icon icon="solar:card-recive-broken"></iconify-icon>
                        <span class="match_bold">Instruments Payment List</span>
                    </a>
                </li>
            @endif
            ...
            @endif
            @if (menuPermission('Supplier Purchase'))
                <li
            ...
            @if (menuPermission('Material Stock'))
                <li class="parent-menu treeview menu_assign_class menu__cidirp_1{{ request()->is('material_stocks*') || request()->is('getLowStock*') || request()->is('stock-adjustment*') || request()->is('material_stock_return*') ? ' menu-open active_sub_menu' : '' }}"
                    data-menu__cid="irp_1">
                    <a href="#">
            ...
            @endif
            @if (menuPermission('Inspection Report'))
            ...
            <li
                class="parent-menu treeview menu__cidirp_10{{ request()->is('sale-report*') || request()->is('expense-report*') || request()->is('salary-report*') || request()->is('po-report*') || request()->is('production-report*') || request()->is('supplier-purchase-report*') || request()->is('customer-report*') || request()->is('instrument-report*') || request()->is('load-instrument-report*') || request()->is('payment-report*') ? ' menu-open active_sub_menu' : '' }}">
                <a href="#">
                    <iconify-icon icon="solar:diagram-down-broken"></iconify-icon>
                    <span class="match_bold">@lang('index.report')</span>
                </a>
                <ul class="treeview-menu">
                    @if (routePermission('customer-report'))
                        <li class="menu_assign_class {{ request()->routeIs('customer-report') ? ' treeMenuActive' : '' }}" data-menu__cid="irp_10"><a href="{{ route('customer-report') }}">Customer Report</a></li>
                    @endif
                    @if (routePermission('po-report'))
                        <li class="menu_assign_class {{ request()->routeIs('po-report') ? ' treeMenuActive' : '' }}" data-menu__cid="irp_10"><a href="{{ route('po-report') }}">PO Report</a></li>
                    @endif
                    {{-- @if (routePermission('production-report'))
                        <li class="menu_assign_class {{ request()->routeIs('production-report') ? ' treeMenuActive' : '' }}" data-menu__cid="irp_10"><a href="{{ route('production-report') }}">Production Report</a></li>
                    @endif
                    @if (routePermission('supplier-purchase-report'))
                        <li class="menu_assign_class {{ request()->routeIs('supplier-purchase-report') ? ' treeMenuActive' : '' }}" data-menu__cid="irp_10"><a href="{{ route('supplier-purchase-report') }}">Supplier Purchase Report</a></li>
                    @endif --}}
                    @if (routePermission('report.sales'))
                    ...
                    @endif
                    @if (routePermission('instrument-report'))
                        <li class="menu_assign_class {{ request()->routeIs('instrument-report') || request()->routeIs('load-instrument-report') ? ' treeMenuActive' : '' }}" data-menu__cid="irp_10"><a href="{{ route('instrument-report') }}">Instrument Report</a></li>
                    @endif
                    @if (routePermission('payment-report'))
                        <li class="menu_assign_class {{ request()->routeIs('payment-report') ? ' treeMenuActive' : '' }}" data-menu__cid="irp_10"><a href="{{ route('payment-report') }}">Payment Report</a></li>
                    @endif
