                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 mb-2 col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="mat_type" id="mat_type" class="form-control @error('mat_type') is-invalid @enderror" placeholder="@lang('index.mat_type')" value="{{ isset($material_type) && $material_type ? $material_type->type_name : old('mat_type') }}" readonly>
                            </div>
                        </div>
                        <div class="col-sm-12 mb-2 col-md-4">
                            <div class="form-group">
