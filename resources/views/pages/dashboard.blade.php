...
@section('content')
    ...
    <section class="main-content-wrapper dashboard-wrapper">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-sm-6">
                <a class="text-dec-none" href="{{ route('instruments.index') }}">
                    <div class="small-box box4column">
                        <div class="inner b-l-primary">
                            <p>Total Instrument</p>
                            <h3>{{ numberFormat($total['instrument']) }}</h3>
                        </div>
                        <div class="icon">
                            <img src="{!! $baseURL . 'frequent_changing/images/products.png' !!}" alt="" class="">
                        </div>
                    </div>
                </a>
            </div>
            ...
            <div class="col-lg-3 col-sm-6">
                <a class="text-dec-none" href="{{ route('partners.index') }}">
                    <div class="small-box box4column">
                        <div class="inner b-l-danger">
                            <p>Total Partners</p>
                            <h3>{{ numberFormat($total['partner']) }}
                            </h3>
                        </div>
                        <div class="icon">
                            <img src="{!! $baseURL . 'frequent_changing/images/supplier.png' !!}" alt=""
                                    ...
                                    @foreach ($running_order as $value)
                                        @foreach ($value->details as $detail)
                                            <tr>
                                                ...
                                                <td>{{ safe(getDateFormat($detail->delivery_date)) }}</td>
        ...
        <div class="row mt-3">
            <div class="col-md-6">
                <div class="box-wrapper">
                    <div class="box-header with-border">
                        <h3 class="box-title"><iconify-icon icon="solar:card-send-broken"></iconify-icon><span
                                class="ms-2">Customer I/O</span></h3>
                        <input type="hidden" class="datatable_name" data-title="{{ isset($title) && $title ? $title : '' }}" data-id_name="datatable_7">
                    </div>
                    <div class="table-box mt-2">
                        <!-- /.box-header -->
                        <div class="table-responsive">
            ...
            <div class="col-md-6">
                <div class="box-wrapper">
                    <div class="box-header with-border">
                        <h3 class="box-title"><iconify-icon icon="solar:card-send-broken"></iconify-icon><span class="ms-2">Partner I/O</span></h3>
                        <input type="hidden" class="datatable_name" data-title="{{ isset($title) && $title ? $title : '' }}" data-id_name="datatable_8">
                    </div>
                    <div class="table-box mt-2">
                        <!-- /.box-header -->
                        <div class="table-responsive">
                            <table id="datatable_8" class="table table-striped datatable_dashboard">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="width_10_p">@lang('index.instrument_name')(Code)</th>
                                        <th class="width_10_p">@lang('index.quantity')</th>
                                        <th class="width_10_p">@lang('index.status')</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @if ($partner_io && !empty($partner_io))
                                    <?php
                                    $j = 1;
                                    ?>
                                    @endif
