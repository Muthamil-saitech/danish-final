            ...
            <div class="table-box">
                ...
                <div>
                    <div class="row">
                        ...
                        <div class="col-sm-12 mb-2 col-md-4 {{ isset($obj) ? "" : "d-none" }}" id="old_mat_no_div">
                            <div class="form-group">
                        ...
                        <div class="col-sm-12 mb-2 col-md-4 {{ !isset($obj) || (isset($obj) && $obj->stock_type == 'customer') ? 'd-none' : '' }}" id="select_ref_no">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('reference_no_purchase') is-invalid @enderror select2"
                                    ...
                                    <option value="">@lang('index.select')</option>
                                    @if(isset($obj) && $obj->stock_type == "purchase" && isset($purchases))
                        ...
                        <div class="col-sm-12 mb-2 col-md-4 {{ !isset($obj) || (isset($obj) && $obj->stock_type == 'customer') ? '' : 'd-none' }}" id="inp_ref_no_div">
                            <div class="form-group">
                                <label>@lang('index.po_no') <span class="required_star">*</span></label>
                                <select class="form-control @error('reference_no_customer') is-invalid @enderror select2"
                                    name="reference_no_customer" id="inp_ref_no">
                                    <option value="">@lang('index.select')</option>
                                    @if(isset($obj) && $obj->stock_type == "customer" && isset($purchases))
                                        @foreach($purchases as $po)
                                            <option value="{{ $po->customerOrder->reference_no.'/'.$po->line_item_no }}"
                                                {{ (isset($obj->reference_no) && $obj->reference_no == $po->customerOrder->reference_no) || old('reference_no') == $po->customerOrder->reference_no ? 'selected' : '' }}>
                                                {{ $po->customerOrder->reference_no.'/'.$po->line_item_no }}
                                            </option>
                                        @endforeach
                                    @endif
                                </select>
                        ...
                        <div class="col-sm-12 mb-2 col-md-4">
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control" name="mat_qty" id="mat_qty" value="{{ isset($obj->mat_qty) ? $obj->mat_qty : old('mat_qty') }}" placeholder="@lang('index.stock')" min="0" readonly>
                                <input type="text" class="form-control @error('current_stock') is-invalid @enderror" name="current_stock" id="current_stock" value="{{ isset($obj->current_stock) ? $obj->current_stock : old('current_stock') }}" placeholder="@lang('index.stock')" min="0">
                                <div class="text-danger d-none"></div>
                                @error('current_stock')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-sm-12 mb-2 col-md-4">
                            <div class="form-group">
                                <label>Customer DC No <span class="required_star">*</span></label>
                                <input type="text" name="dc_no" class="form-control" id="dc_no" placeholder="Customer DC No" value="{{ isset($obj) && $obj->dc_no!='' ? $obj->dc_no : old('dc_no') }}">
                                <div class="text-danger d-none"></div>
                                @error('dc_no')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-sm-12 mb-2 col-md-4">
                            <div class="form-group">
                                <label>Customer DC Date <span class="required_star">*</span></label>
                                {!! Form::text('date', isset($obj->dc_date) && $obj->dc_date!='' ? date('d-m-Y',strtotime($obj->dc_date)) : (old('dc_date') ?: ''), [
                                    'class' => 'form-control',
                                    'placeholder' => 'Customer DC Date',
                                    'id' => 'dc_date',
                                ]) !!}
                                <div class="text-danger d-none"></div>
