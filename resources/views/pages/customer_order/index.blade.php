        ...
        <div class="table-box">
            ...
            <div class="table-responsive">
                <table id="datatable" class="table table-striped">
                    <thead>
                        <tr>
                            <th class="width_10_p">@lang('index.so_entry_no')</th>
                    ...
                    <tbody>
                        ...
                        @foreach ($obj as $value)
                            ...
                            <tr>
                                ...
                                <td>{{ getAmtCustom($detail->sub_total + $detail->reorder_total) }}</td>
                                ...
                                <td>
                                    ...
                                    @endif
                                    @if (routePermission('view-reorder-logs'))
                                        @php
                                        ...
                                        @endphp
                                        @if ($hasLogs)
                                            <a href="{{ url('customer-orders') }}/{{ encrypt_decrypt($detail->id, 'encrypt') }}/order_edit_logs" class="button-info" data-bs-toggle="tooltip" data-bs-placement="top" title="View Reorder Logs"><i class="fa fa-list"></i></a>
                                        @endif
                                    @endif
