                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6 mb-2 col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="hidden" name="start_date_m" value="{{ isset($obj->start_date) && $obj->start_date!='' ? date('d-m-Y',strtotime($obj->start_date)) : (old('start_date_m') ?: date('d-m-Y',strtotime($selected_po_date))) }}" id="po_date_hidden">
                                <input type="text" id="start_date"
                                    class="form-control @error('start_date') is-invalid @enderror"
                                    placeholder="Start Date"
                                    value="{{ isset($obj->start_date) && $obj->start_date != ''  ? date('d-m-Y', strtotime($obj->start_date)) : ( old('start_date_m')  ?: (isset($selected_po_date) && $selected_po_date != ''  ? date('d-m-Y', strtotime($selected_po_date)) : '') ) }}" disabled>
                                <div class="text-danger d-none"></div>
                                @error('start_date')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-sm-12 col-md-6 mb-2 col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="hidden" name="complete_date_m" value="{{ isset($obj->complete_date) && $obj->complete_date!='' ? date('d-m-Y',strtotime($obj->complete_date)) : (old('complete_date_m') ?: date('d-m-Y',strtotime($selected_complete_date))) }}" id="complete_date_hidden">
                                <input type="text" id="complete_date"
                                    ...
                                    value="{{ isset($obj->complete_date) && $obj->complete_date != ''  ? date('d-m-Y', strtotime($obj->complete_date)) : ( old('complete_date_m')  ?: (isset($selected_complete_date) && $selected_complete_date != ''  ? date('d-m-Y', strtotime($selected_complete_date)) : '') ) }}" disabled>
                                <div class="text-danger d-none"></div>
                                @error('complete_date')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="drawer_no" id="drawer_no">
                                    ...
                                    @foreach ($drawers as $value)
                                        <option value="{{ $value->id.'|'.$value->drawer_no }}" {{ old('drawer_no') == $value->drawer_no || isset($selected_drawer) && $selected_drawer == $value->drawer_no ? 'selected' : '' }}>
                                            {{ $value->drawer_no }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                @if (isset($obj->product_id) && $obj->product_id !== '')
                                    ...
                                    <input type="text"
                                        ...
                                        id="fproduct_id" value="{{ getFinishProduct($obj->product_id) }}" readonly>
                                    <?php
                                    if (isset($obj->product_id) && $obj->product_id) {
                                            ...
                                            @foreach ($m_rmaterials as $key => $value)
                                                <tr class="rowCount" data-id="{{ $value->rmaterials_id }}">
                                                    ...
                                                    <td><input type="hidden" value="{{ $value->stock_id }}"
                                                            name="stock_id[]">
                                                        <input type="hidden" value="{{ $value->material_qty }}"
                                                            name="material_qty[]">
                                                                ...
                                                                <div class="col-xl-12 col-md-12">
                                                                    <div class="input-group">
                                                                        <input
                                                                            ...
                                                                            placeholder="Minutes" readonly><span
                            ...
                            <div class="col-xl-12">
                                <div class="table-responsive" id="purchase_cart">
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="w-25">Completed Time</th>
                                                <th class="w-25">Work Centre</th>
                                                    ...
                                                    <tr class="rowCount3" data-id="{{ $value->production_stage_id }}"
                                                        ...
                                                        <td>
                                                            <input type="text"
                                                                ...
                                                                disabled style="min-width:120px;">
                                                            <input type="hidden"
                                                        ...
                                                        <td>
                                                            <div class="input-group">
                                                                <input type="text" id="manufacture_task" name="task[]" class="form-control @error('title') is-invalid @enderror changeableInput" value="{{ $value->task }}" placeholder="Task" style="min-width:120px;">
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <select class="form-control manufacture_stage_id changeableInput" name="user_id_scheduling[]" id="manufacture_user_id_{{ $m }}" style="min-width:120px;">
                                                        ...
                                                        <td>
                                                            ...
                                                            <input type="number" id="manufacture_task_hours" name="task_hours[]" class="form-control @error('title') is-invalid @enderror changeableInput" value="{{ $value->task_hours }}" placeholder="Task Hours" style="min-width:120px;">
                                                        </td>
                                                        <td>
                                                            <input type="hidden" name="task_status[]" class="edit_post_status" value="{{ $value->task_status }}">
                                                            <select class="form-control task_status changeableInput" id="task_status_{{ $m }}" {{ isset($value->task_status) && $value->task_status=="3" ? "disabled" : "" }} style="min-width:120px;">
                                                                <option value="" disabled>@lang('index.select')</option>
                                                        ...
                                                        <td>
                                                            <div class="input-group">
                                                                <input type="text"
                                                                    ...
                                                                    placeholder="Complete Date" style="min-width:120px;">
                                                            </div>
                                                            <p class="text-danger end_date_error d-none"></p>
                                                        </td>
                                                        <td>
                                                            <div class="input-group">
                                                                <input type="number" id="manufacture_complete_hours" name="complete_hours[]" class="form-control @error('title') is-invalid @enderror changeableInput" value="{{ $value->complete_hours==0 ? 0 : $value->complete_hours }}" placeholder="Minutes" {{ $value->task_status == 3  ? '' : 'readonly'}} style="min-width:120px;">
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <input type="text" id="manufacture_work_centre" name="work_centre[]" class="form-control @error('title') is-invalid @enderror changeableInput" value="{{ $value->work_centre==0 ? '' : $value->work_centre }}" placeholder="Work Centre" {{ $value->task_status == 3 ? '' : 'readonly'}} style="min-width:180px;">
                                                        </td>
                                                        <td>
                                    ...
                                    <button id="scheduling_add" data-bs-toggle="modal"
                                        data-bs-target="#productScheduling" class="btn bg-blue-btn w-20 mt-2 mb-3"
