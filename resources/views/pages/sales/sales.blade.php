...
<section class="main-content-wrapper">
    ...
    <section class="content-header">
        <div class="row">
            ...
            <div class="col-md-6 text-end">
                <h5 class="mb-0">Total Sales Invoice List: {{ isset($obj) ? count($obj) : '0' }} </h5>
            </div>
        </div>
    </section>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @endif
                                <a class="button-success" id="creditModal" data-bs-toggle="modal" data-sale_id="{{ $value->id }}" data-bs-target="#creditDebitPay" data-bs-toggle="tooltip" data-bs-placement="top" title="Credit/Debit Entry"><i class="fa-solid fa-receipt"></i></a>
                                <a href="{{ url('sales') }}/{{ encrypt_decrypt($value->id, 'encrypt') }}/sales_items_list" class="button-info" data-bs-toggle="tooltip" data-bs-placement="top" title="View Sales Items"><i class="fa fa-list"></i></a>
                                {{-- <a href="{{ url('sales') }}/{{ encrypt_decrypt($value->id, 'encrypt') }}/invoice_note_entry" class="button-info" data-bs-toggle="tooltip" data-bs-placement="top" title="View Credit/Debit Entries"><i class="fa fa-list"></i></a> --}}
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
    ...
    <div class="modal fade" id="creditDebitPay" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel">Credit / Debit Entry</h4>
                ...
                <form method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-4 mb-2">
                                <div class="form-group">
                                    <label class="control-label">@lang('index.type') <span class="required_star">*</span></label>
                                    <select class="form-control @error('type') is-invalid @enderror select2" name="type" id="type">
                            ...
                            <div class="col-sm-12 col-md-4 mb-2">
                                <div class="form-group">
                                    <label class="control-label">@lang('index.part_name') (@lang('index.part_no'))<span class="required_star">*</span></label>
                                    <input type="hidden" class="form-control" name="sale_id" id="sale_id">
                                    <select name="product_id" id="product_id" class="form-control select2">
                                        <option value="">Please Select</option>
                                    </select>
                                    <p class="text-danger product_err"></p>
                                </div>
                            </div>
                            {{-- <div class="col-sm-12 col-md-6 mb-2">
                                <div class="form-group">
                                    <label class="control-label">@lang('index.price') <span class="required_star">*</span></label>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn bg-blue-btn sales_note_submit"><iconify-icon icon="solar:check-circle-broken"></iconify-icon> @lang('index.submit')</button>
                    </div>
                </form>
            </div>
        </div>
...
<script>
    ...
    $(document).on("click", "#creditModal", function(e) {
        e.preventDefault();
        ...
        $.ajax({
            type: "POST",
            url: hidden_base_url + "getSalesItems",
    ...
    $(document).on("click", ".sales_note_submit", function(e) {
        e.preventDefault();
        let status = true;
        let hidden_base_url = $("#hidden_base_url").val();
        ...
        let price = $("#price").val();
        if (type == "") {
            $(".type_err").text("The Type field is required.");
            status = false;
        } else {
            $(".type_err").text("");
        }
        if (product_id == "") {
            $(".product_err").text("The Part Name field is required.");
            status = false;
        } else {
            $(".product_err").text("");
        }
        ...
        $.ajax({
            type: "POST",
            url: hidden_base_url + "salesNoteEntry",
            data: {
                sale_id: sale_id,
                type: type,
