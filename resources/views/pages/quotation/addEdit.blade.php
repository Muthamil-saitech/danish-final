                    ...
                    <div class="row">
                        <div class="col-sm-12 mb-2 col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::text('challan_date', isset($obj->challan_date) && $obj->challan_date!='' ? date('d-m-Y',strtotime($obj->challan_date)) : (old('challan_date') ?: date('d-m-Y')), [
                                    'class' => 'form-control',
                                    'id' => 'challan_date',
                                    'placeholder' => 'DC Date',
                                ]) !!}
                        ...
                        <div class="col-sm-12 mb-2 col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::text('challan_no', isset($obj->challan_no) && $obj->challan_no != '' ? $obj->challan_no : (old('challan_no') ?: (isset($challan_no) && $challan_no != '' ? $challan_no : '')), [
                    ...
                    <div class="row">
                        <div class="col-sm-12 mb-2 col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control select2 select2-hidden-accessible" name="product_id[]" id="dcproduct_id" multiple>
                                        ...
                                        @if (isset($quotation_details) && $quotation_details)
                                            @foreach ($quotation_details as $key => $value)
                                                ...
                                                <tr class="rowCount" data-id="{{ $value->product_id }}">
                                                    ...
                                                    <td>
                                                        <span><input type="hidden" name="price[]" class="form-control" placeholder="Rate" value="{{ $value->price }}" id="finalPrice" style="min-width: 120px;">{{ $value->price }}</span>
                                                    </td>
                                                    <td>
                                                        <input type="hidden" value="{{ $productInfo->id.'|'. $value->customer_order_id.'|'.$value->manufacture_id }}" name="selected_product_id[]">
                                                    ...
                                                    <td>
                                                        <textarea class="form-control" name="challan_ref[]" placeholder="Challan Reference" rows="3" cols="50" style="min-width: 180px;" readonly>{{ $value->challan_ref }}</textarea>
                                                    </td>
                                                    <td>
