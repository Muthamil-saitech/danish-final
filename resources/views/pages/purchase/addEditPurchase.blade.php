                ...
                <div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('purchase_mat_type') is-invalid @enderror select2" name="mat_type" id="purchase_mat_type">
                                    ...
                                    @foreach ($material_types as $value)
                                        <option
                                            {{ (isset($obj->mat_type) && $obj->mat_type == $value->id) || old('mat_type') == $value->id || (isset($mat_type_id) && in_array($value->id, (array) $mat_type_id)) ? 'selected' : '' }}
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('category') is-invalid @enderror select2" name="category"
                                    ...
                                    @foreach ($categories as $value)
                                        <option
                                            {{ (isset($obj->category) && $obj->category == $value->id) || old('category') == $value->id || (isset($mat_cat_id) && in_array($value->id, (array) $mat_cat_id)) ? 'selected' : '' }}
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-3">
                            ...
                            {{-- <div class="row mb-1">
                                <label class="custom_label">@lang('index.tax_percentage')</label>
                                <div class="input-group">
                                    <input type="text" name="tax_percent" id="tax_percent" class="form-control @error('tax_percent') is-invalid @enderror cal_row" placeholder="@lang('index.tax_percentage')" value="{{ isset($obj->tax_percent) ? $obj->tax_percent : old('tax_percent') }}">
                                    <span class="input-group-text">%</span>
                                </div>
                            </div>
                            <div class="row mb-1">
                                <label class="custom_label">@lang('index.tax_amount')</label>
                                <div class="input-group">
                                    <input type="text" name="tax_amount" id="tax_amount" class="form-control @error('tax_amount') is-invalid @enderror integerchk" placeholder="@lang('index.tax_amount')" value="{{ isset($obj->tax_amount) ? $obj->tax_amount : old('tax_amount') }}" readonly>
                                    <span class="input-group-text">{{ $setting->currency }}</span>
                                </div>
                            </div> --}}
                            <div class="row mb-1">
