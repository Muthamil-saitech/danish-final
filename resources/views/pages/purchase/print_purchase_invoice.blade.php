...
<body>
    ...
    <div class="m-auto b-r-5 p-30">
        ...
        <table class="w-100 mt-20 purchase_table">
            <thead class="b-r-3">
                <tr>
                ...
                @if (isset($pruchse_rmaterials) && $pruchse_rmaterials)
                    ...
                    @foreach ($pruchse_rmaterials as $key => $value)
                        <tr class="rowCount" data-id="{{ $value->finishProduct_id }}">
                            ...
                            <td class="text-center pr-10">{{ $value->tax_percent }} %</td>
                            <td class="text-center pr-10" style="font-family: DejaVu Sans, sans-serif;">₹{{ number_format($value->tax_amount,2) }}
                            </td>
            ...
            <tr>
                ...
                <td class="w-50">
                    ...
                    {{-- <table>
                        <tr>
                            <td class="w-50">
                                <p class="f-w-600">@lang('index.tax_amount')</p>
                            </td>
                            <td class="w-50 text-right pr-0">
                                <p style="font-family: DejaVu Sans, sans-serif;">₹{{ number_format($obj->tax_amount,2) }} <br>{{ '('.$obj->tax_percent.'%'.')' }}</p>
                            </td>
                        </tr>
                    </table> --}}
                    <table>
