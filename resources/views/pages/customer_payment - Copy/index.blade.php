                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-4 mb-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('tds_amount') is-invalid @enderror cal_row" name="tds_amount" id="tds_amount" placeholder="TDS Amount">
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-4 mb-2">
                                <div class="form-group">
...
<script>
    $(document).on("click", "#customerDueModal", function(e) {
        ...
        var tds_amount = $(this).data('tds_amount');
        if(tds_amount == 0.00) {
            $('#tds_amount').val(tds_amount).prop('readonly', false);
        } else {
            $('#tds_amount').val(tds_amount).prop('readonly', true);
        }
    });
    function cal_row() {
        let total_amount = $("#total_amount").val();
        let tds_amount = $("#tds_amount").val();
        let balance_amount = $("#balance_amount").val();
        let final_amount = 0;
        if(total_amount == balance_amount) {
            final_amount = parseFloat(total_amount) - parseFloat(tds_amount ? tds_amount : 0);
            $("#balance_amount").val(final_amount.toFixed(2));
        } else {
            final_amount = parseFloat(balance_amount) - parseFloat(tds_amount ? tds_amount : 0);
            $("#balance_amount").val(final_amount.toFixed(2));
        }
    }
    $(document).on("change", ".cal_row", function (e) {
        cal_row();
    });
