$(document).ready(function () {
    ...
    $("#dc_form").submit(function (e) {
        ...
        if (challan_no == "") {
            status = false;
            showErrorMessage("challan_no", "The DC No field is required");
        } else {
        ...
        // if (material_doc_no == "") {
        //     status = false;
        //     showErrorMessage("material_doc_no", "The Challan No / Material Doc No field is required");
        // } else {
    ...
    $(document).on("change", "#dcproduct_id", function (e) {
        ...
        selectedOptions.each(function () {
            ...
            if (val) {
                let parts = val.split("|");
                selectedProductIds.push($(this).val()); // only product_id
            }
        });
        ...
        $(".add_tr .rowCount").each(function () {
            ...
            if (!selectedProductIds.includes(rowKey)) {
                $(this).remove();
            }
        });
        ...
        selectedOptions.each(function () {
            ...
            if (params !== "") {
                ...
                let rowKey = params;
                if ($(`.rowCount[data-key='${rowKey}']`).length > 0) {
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        manufacture_id: item_details_array[2],
                    },
                    success: function (response) {
                        let data = JSON.parse(response);
                        ...
                        let html = `
                            <tr class="rowCount" data-key="${params}">
                                ...
                                <td class="w-10"><textarea class="form-control" name="challan_ref[]" placeholder="Challan Reference" rows="3" cols="50" maxlength="50" style="min-width: 180px;" readonly>${data.mat_doc_no}</textarea></td>
                                <td class="w-20"><textarea class="form-control" name="description[]" placeholder="Remarks" rows="3" cols="50" maxlength="50" style="min-width: 180px;"></textarea></td>
