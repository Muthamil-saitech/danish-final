(function ($) {
    ...
    setTimeout(() => {
        ...
        `);
        } else if (filter_status === "no") {
           $(document).find(".exportDropdown .toggleBtn").hide();
        } else {
            $(document).find(".exportDropdown .toggleBtn").show();
        }

        justWorkForTable();
        $(".dt-buttons button.buttons-print").hide(); // Hide Print
        $(".dt-buttons button.buttons-pdf").hide();
    }, 300);
